...
classes = scipy.io.loadmat(r'C:\Users\tomi8\Desktop\Dataset\devkit\cars_meta.mat',squeeze_me=True)
test    = scipy.io.loadmat(r'C:\Users\tomi8\Desktop\Dataset\devkit\cars_train_annos.mat',squeeze_me=True) 
trainingImagesPath = pathlib.Path(r'C:\Users\tomi8\Desktop\Dataset\cars_train')
